...
*/
	...
	function instalar(){
		...
		if(!$this->db->table_exists('sadacod')){
			...
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('98' , 'Tomate Industrial')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('95' , 'Otros Productos del Mar')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('94' , 'Vinagre')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('89' , 'Maiz de Cotufa (TM)')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('84' , 'Carne de Porcino despostada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('82' , 'Carne de Porcino en Canal')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('75' , 'Melaza')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('73' , 'Azucar Crudo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('72' , 'Semola de Trigo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('70' , 'Semilla de Arroz Humedo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('65' , 'ABA Materia Prima (Alimentos Balanceados para Animales)')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('64' , 'Harinas Derivadas de otros Productos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('62' , 'Cascarilla de Arroz')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('60' , 'Soya Acondicionada (Frijol de Soya)(TM)')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('59' , 'Ajonjoli ')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('56' , 'Cebada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('553', 'Sal Cruda')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('547', 'Almidones Modificados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('537', 'Agua')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('529', 'Harina Integral de Trigo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('525', 'Platano')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('52' , 'Formula Preinfantil')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('51' , 'Avena')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('50' , 'Sorgo Acondicionado (TM)')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('490', 'Aceites  Otros- Soya-Canola-Oliva')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('49' , 'Caraota Roja')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('488', 'Aceite 18Lts Industrial')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('48' , 'Caraota Rosada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('478', 'Leche en Polvo Descremada - Uso Industrial MP')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('476', 'Leche en Polvo Completa - Uso Industrial MP')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('472', 'Manteca de Cerdo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('47' , 'Caraotas Blanca')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('46' , 'Caraota Negra')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('459', 'Vegetales Deshidratados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('458', 'Quinchoncho')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('457', 'Jarabe de Glucosa')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('455', 'Alfalfa')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('453', 'Lomo de Atun')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('451', 'Ácidos Grasos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('450', 'Huevos de Codorniz')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('45' , 'Frijol')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('445', 'Subproducto de Aves')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('444', 'Harinas proteicas para animales')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('443', 'Frutos secos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('441', 'Pollo Despresado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('437', 'Avena en Granos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('436', 'Maiz Amarillo - Consumo Humano')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('434', 'Oleina Vegetal')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('43' , 'Jurel (Enlatado)')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('423', 'Harina derivado de maiz para ABA')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('421', 'Harina Amarilla de Arroz')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('42' , 'Maiz Blanco  - Acondicionado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('416', 'Harina de Coco y Coco Rayado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('414', 'Bebidas Lacteas [Miles de Litros]')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('413', 'Turron')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('412', 'Maiz Pilado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('41' , 'Trigo Durum')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('409', 'Alimentos Preparados listos para Servir')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('408', 'Quesos fundidos y Pastas para Untar')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('407', 'Filetde Mero')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('406', 'Mero Entero')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('405', 'Tocino y piel de cerdo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('404', 'Filetes de Dorado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('403', 'Filetes de Merluza')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('402', 'Filetes de Salmon')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('401', 'Dorado Entero')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('400', 'Merluza Entera')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('40' , 'Maiz Amarillo - Acondicionado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('399', 'Bacalao Seco')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('398', 'Salmon Ahumado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('397', 'Salmon Entero')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('395', 'Gallina Beneficiada entera')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('394', 'Sub Productos de Bovino')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('389', 'Pellets de Cereales')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('388', 'Ajo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('384', 'ABA Alimentos para peces')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('382', 'Premezcla Minerales')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('381', 'Premezcla de Vitaminas y Aminoacidos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('380', 'Preparado de Mayonesa')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('38' , 'Lentejas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('379', 'Pepitonas Enlatadas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('378', 'Pepitonas Frescas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('375', 'Tomate en Conserva')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('374', 'Avena Liquida [Litros]')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('373', 'Preparaciones a Base de Cereales')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('372', 'Tomate Pelado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('37' , 'Enlatados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('366', 'Suero en polvo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('365', 'Oleina de Palma')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('363', 'Encurtidos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('362', 'Pastas Uso Industrial')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('361', 'Casabe')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('360', 'Leche Liquida Pasteurizada No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('359', 'Leche Liquida Pasteurizada Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('358', 'Cafe Molido Presentacion No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('357', 'Cafe Molido Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('356', 'Preparaciones Alimenticias Diversas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('354', 'Jurel Fresco')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('352', 'Harina de Arroz')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('351', 'Miel')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('350', 'Azucares y Derivados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('35' , 'Levadura')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('348', 'Quinchoncho')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('347', 'Afrechillo Consumo Humano')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('346', 'Afrecho y Afrechillo Consumo Animal ')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('345', 'Hortalizas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('342', 'Pescado Varios')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('341', 'Pescado Salado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('34' , 'Jugos  Nectares y Cocteles [Litros]')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('334', 'Sardina Fresca')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('326', 'Azucar Industrial')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('325', 'Azucar Domestica')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('324', 'Lecitina de Soya')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('322', 'Otras Especies de Agua Dulce')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('321', 'Quesos Presentacion No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('320', 'Quesos Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('32' , 'Manteca Vegetal')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('318', 'Atun Entero')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('317', 'Sardina Enlatada Presentacion No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('316', 'Sardina Enlatada Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('315', 'Atun Enlatado Presentacion No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('314', 'Atun Enlatado Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('313', 'Pastas Alimenticias  No Reguladas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('312', 'Pastas Alimenticias Reguladas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('311', 'Mayonesa')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('310', 'Mayonesa Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('309', 'Margarina -Consumo Industrial-')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('308', 'Margarina -Consumo Domestico-')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('307', 'Salsa de Tomate -Ketchup-')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('306', 'Salsa de Tomate Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('305', 'Pasta de Tomate-Prod Terminado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('304', 'Crema de Leche - Prod Terminado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('303', 'Avena Despuntada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('302', 'Subproductos de Cerdo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('30' , 'Sal Refinada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('299', 'Cafe Tostado en Grano')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('298', 'Concentrados de Frutas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('297', 'Girasol -  Acondicionado (TM)')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('296', 'Ciruelas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('295', 'Cerezas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('291', 'Extractos - escencias y concentrados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('290', 'Harina de Trigo Galletera')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('29' , 'Pollo Beneficiado Entero')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('286', 'Semilla de Girasol - Acondicionado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('284', 'Residuos de las Industrias Alimentarias')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('282', 'Grasa Uso Industrial')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('281', 'Aceite Uso Industrial')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('277', 'Suero de Leche')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('276', 'Semilla de Pasto')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('275', 'Mani')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('273', 'Helados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('272', 'Articulos de Galleteria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('271', 'Articulos de Chocolateria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('270', 'Semilla de Soya Humeda')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('269', 'Centeno')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('268', 'Kiwi')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('266', 'Pescado congelado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('264', 'Arroz de Tercera')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('263', 'Manteca de Cacao')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('262', 'Licor de Cacao')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('261', 'Cacao en polvo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('260', 'Cacao en granos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('259', 'Formulas Lácteas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('257', 'Aceite  No Regulado ')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('256', 'Aceite Regulado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('255', 'Pulpa de Frutas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('253', 'Uvas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('252', 'Peras')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('251', 'Manzanas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('250', 'Duraznos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('25' , 'Mantequilla')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('249', 'Pasta de Tomate - Materia Prima')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('244', 'Aceite Crudo de Soya')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('240', 'Grasa Amarilla')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('24' , 'Leche Condensada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('239', 'Cafe Liofilizado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('238', 'Leche Liquida UHT [Litros]')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('236', 'Aji')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('235', 'Atun Congelado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('233', 'Leche en Polvo Descremada - Uso Domestico')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('232', 'Leche en Polvo Completa - Uso Domestico')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('231', 'Carne de Aves -pavo pato codorniz avestruz entre otras-')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('23', 'Leche Evaporada [Litros]')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('229', 'Semilla de Tomate')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('228', 'Semilla de Zanahoria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('227', 'Semilla de Cebolla')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('226', 'Semilla de Girasol  Humedo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('225', 'Semilla de Sorgo Humedo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('224', 'Semilla de Maiz Blanco Acondicionado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('223', 'Semilla de Maiz Amarillo Acondicionado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('222', 'Semilla de Papa')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('221', 'Harina de Trigo Familiar')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('220', 'Carne de Bovino Despostado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('22' , 'Huevos de Consumo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('218', 'Carne de Bovino en Canal')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('217', 'Harina de Soya -Torta de Soya-')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('215', 'Cebolla en Salmuera')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('213', 'Panetton')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('212', 'Mermeladas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('211', 'Alcaparras')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('210', 'Aceitunas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('209', 'Avellanas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('207', 'Nueces')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('206', 'Uvas Pasas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('205', 'Onoto')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('204', 'Harina de Maiz Precocida No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('203', 'Harina de Maiz Precocida Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('202', 'Harina de Trigo para Pastificio')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('201', 'Arroz Blanco Presentacion Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('200', 'Arroz Blanco Presentacion No Regulada')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('20' , 'Harina de Trigo para Panaderia y Pasteleria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('198', 'Maiz G X M  Blanco ABA Acondicionado')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('197', 'Tomate Fresco')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('196', 'Pernil - Cerdo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('195', 'Cebolla')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('194', 'Pimenton')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('193', 'Papa')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('19' , 'Cafe Molido')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('188', 'ABA Animales Domesticos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('187', 'ABA Cerdos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('186', 'ABA Bovinos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('185', 'ABA Aves')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('184', 'Trigo  Multiples Usos - Panaderia y Pastaleria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('179', 'Raices y Tuberculos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('178', 'Leche Cruda [Litros]')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('174', 'Trigo para Galletas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('173', 'Productos de Panaderia y Pasteleria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('172', 'Articulos de Confiteria')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('170', 'Semillas Otras')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('169', 'Cereales')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('168', 'Congelados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('167', 'Salsas Varias')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('166', 'Condimentos y Especies')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('162', 'Derivados Lacteos')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('161', 'Carne de Ovino ')");
			...
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('138', 'Preparaciones a base de carne -congelada y refrigerada-')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('133', 'Arequipe')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('129', 'Frutas en Almibar o Confitadas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('128', 'Vegetales Enlatados')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('126', 'Maiz Dulce ')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('124', 'Fororo')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('123', 'Arvejas')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('120', 'Arroz de Segunda')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('118', 'Pasta de Especialidades')");
			$this->db->simple_query("INSERT INTO `sadacod` (`codigo`, `descrip`) VALUES ('116', 'Complementos Alimenticios y Dieteticos')");
